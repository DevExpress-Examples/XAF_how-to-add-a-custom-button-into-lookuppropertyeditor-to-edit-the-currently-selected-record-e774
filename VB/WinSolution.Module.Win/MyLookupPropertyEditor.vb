...
Namespace WinSolution.Module.Win
    ...
    Public Class MyLookupPropertyEditor
        ...
        Protected Overrides Sub SetupRepositoryItem(ByVal item As DevExpress.XtraEditors.Repository.RepositoryItem)
            ...
            CType(item, RepositoryItemLookupEdit).Init(Me, DisplayFormat, Helper)
            ...
            AddHandler CType(item, RepositoryItemLookupEdit).ButtonClick, New ButtonPressedEventHandler(AddressOf MyLookupPropertyEditor_ButtonClick)
        End Sub
        ...
        Private Sub MyLookupPropertyEditor_ButtonClick(ByVal sender As Object, ByVal e As ButtonPressedEventArgs)
            If Not e.Button.IsDefaultButton Then
                Dim objectSpace As IObjectSpace = Helper.Application.CreateObjectSpace(ObjectType)
